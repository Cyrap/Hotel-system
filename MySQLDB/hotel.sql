...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2023 at 10:04 PM
...
INSERT INTO `guest_login` (`id`, `username`, `password`) VALUES
(1, 'g', 'g'),
(2, 'dgchvjbk', 'fghjkl'),
(3, 's', 's'),
(4, 'sad', 'asd'),
...
(20, 4, 'suite', '2', 'good', 0),
(22, 6, 'deluxe', '2', 'premium', 0),
(23, 7, 'normal', '1', 'good', 0),
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`reservationID`) REFERENCES `reservation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`guestID`) REFERENCES `guests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
